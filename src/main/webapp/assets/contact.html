                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0">
                        ...
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                            ...
                            <div class="form-row place-order">
                                ...
                                <input type="submit" data-value="Send message" value="Send message" id="Send message" name="woocommerce_checkout_place_order" class="button alt" style="border-radius: 0%;">
